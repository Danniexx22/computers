...
class UnidadController extends Controller
{
    ...
    {
        return $this->render('unidad/index.html.twig', ['unidads' => $unidadRepository->findAll()]);
    }
    ...
    {
        return $this->render('unidad/show.html.twig', ['unidad' => $unidad]);
    }
    ...
    public function edit(Request $request, Unidad $unidad): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('unidad_edit', ['id' => $unidad->getId()]);
        }
