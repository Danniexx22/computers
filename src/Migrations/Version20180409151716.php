 ...
 */
class Version20180409151716 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE computer (id INT AUTO_INCREMENT NOT NULL, modelo_id INT NOT NULL, categoria_id INT NOT NULL, unidad_id INT NOT NULL, serie VARCHAR(255) NOT NULL, marca VARCHAR(255) NOT NULL, codigo VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A298A7A6AA3A9334 (serie), INDEX IDX_A298A7A6C3A9576E (modelo_id), INDEX IDX_A298A7A63397707A (categoria_id), INDEX IDX_A298A7A69D01464C (unidad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
